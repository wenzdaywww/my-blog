...
public interface SysUserMapper extends BaseMapper<SysUserEntity> {
     ...
     * @param userId 用户id
     * @return com.www.myblog.base.data.dto.SysUserDTO
     */
     ...
     * @param page 分页信息
     * @param userDTO 查询条件
     * @return com.baomidou.mybatisplus.extension.plugins.pagination.Page<com.www.myblog.base.data.dto.SysUserDTO>
     */
