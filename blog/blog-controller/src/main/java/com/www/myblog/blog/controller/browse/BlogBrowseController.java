...
public class BlogBrowseController {
     ...
     */
    @GetMapping("cmt-list")
    public Result<List<CommentDTO>> findCommentList(int pageNum, Long bid, Long pid){
     ...
     */
    @GetMapping("article")
    public Result<BlogArticleDTO> findAriticle(Long bid,String ip){
     ...
     */
    @GetMapping("author")
    public Result<AuthorDTO> findAuthorInfo(String id,Long bid){
     ...
     */
    @PostMapping("list")
    public Result<List<BlogArticleDTO>> findAuthorBlogList(BlogArticleDTO query){
     ...
     */
    @GetMapping("group")
    public Result<List<BlogGroupDTO>> findAuthorBlogGroup(String id, Long bid){
     ...
     */
    @GetMapping("tag")
    public Result<List<TagInfoDTO>> findAuthorBlogTag(String id, Long bid){
