...
public interface IUserBlogService {
     ...
     * @param pageNum 页码
     * @param userId 用户id
     * @return com.www.common.data.dto.response.ResponseDTO<java.util.List < com.www.myblog.blog.data.dto.AuthorDTO>> 粉丝用户列表
     */
     ...
     * @param blogId 博客id
     * @param cgId 收藏夹id
     * @return com.www.common.data.dto.response.ResponseDTO<BlogArticleDTO> true添加收藏，false取消收藏
     */
