...
public interface IEditBlogService {
     ...
     */
    Response<Boolean> updateBlogTagAndGroup(BlogArticleDTO blog);
    /**
     ...
     * @return com.www.common.data.dto.response.Response<com.www.myblog.common.dto.BlogArticleDTO>
     */
    Response<BlogArticleDTO> findBlogTagAndGroup(Long blogId);
    /**
     ...
     */
    Response<List<TagInfoDTO>> findAllBlogTag();
    /**
     ...
     * @return com.www.common.data.dto.response.Response<java.util.List < com.www.myblog.blog.data.dto.TagInfoDTO>>
     */
    Response<List<TagInfoDTO>> findUserBlogTag(String userId);
    /**
     ...
     */
    Response<List<BlogArticleDTO>> findBlogList(BlogArticleDTO query);
    /**
     ...
     */
    Response<Long> createBlogArticle(BlogArticleDTO blog, MultipartFile img);
    /**
     ...
     */
    Response<String> createBlogGroup(String userId,String name);
    /**
     ...
     * @return com.www.common.data.dto.response.Response<java.util.List < com.www.myblog.blog.data.dto.BlogGroupDTO>>
     */
    Response<List<BlogGroupDTO>> findBlogGroup(String userId);
}
