...
VALUES ('home','首页',null,'el-icon-lx-home','/home',0,'0',now(),now());
INSERT INTO SYS_MENU (MENU_CODE,MENU_NAME,PARENT_ID,MENU_ICON,MENU_URL,MENU_ORDER,IS_DELETE,SYS_UPDATE_TIME,SYS_CREATE_TIME)
VALUES ('userList','用户列表',null,'el-icon-user','/table',1,'0',now(),now());
INSERT INTO SYS_MENU (MENU_CODE,MENU_NAME,PARENT_ID,MENU_ICON,MENU_URL,MENU_ORDER,IS_DELETE,SYS_UPDATE_TIME,SYS_CREATE_TIME)
VALUES ('userInfo','个人中心',null,'el-icon-s-custom','/user',1,'0',now(),now());
/**请求路径**/
